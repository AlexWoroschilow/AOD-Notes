...
class Loader(Loader):
    ...
    def boot(self, options=None, args=None, dispatcher=None):
        ...
        :return:.
        """
        dispatcher.add_listener('window.notepad.leftbar', self._onWindowNotepadToolbar, 100)
    ...
    def _onWindowNotepadToolbar(self, event=None, dispather=None, storage=None):
        ...
        self._widget.setIcon(QtGui.QIcon("icons/pdf.svg"))
        self._widget.setToolTip("Export document to PDF")
        self._widget.clicked.connect(self._onNotepadExportPdf)
