...
class Loader(Loader):
    ...
    def boot(self, options=None, args=None, kernel=None):
        kernel.listen('window.notepad.leftbar', self._onWindowNotepadToolbar, 200)
        kernel.listen('window.notelist.toolbar', self._onWindowNotepadToolbar, 200)
    ...
    def _onWindowNotepadToolbar(self, event=None):
        ...
        widget.setToolTip(editor.tr("Export document to HTML"))
