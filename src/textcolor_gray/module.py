...
class Loader(Loader):
    ...
    def _onWindowNotepadToolbar(self, event=None, dispather=None, storage=None):
        ...
        self._widget = QtWidgets.QAction(QtGui.QIcon("icons/font-gray.svg"), self._editor.tr("Change the text color to green"), self._toolbar)
    ...
    def _onButtonPressed(self, event=None, dispatcher=None):
        ...
        color = QtGui.QColor.fromRgb(127, 127, 127)
